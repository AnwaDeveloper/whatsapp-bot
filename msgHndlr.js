...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const apiKey = 'IGjYt4zA5SQITDx9z9Ca' // apikey you can get it at https://mhankbarbar.herokuapp.com/api
        ...
        const ownerNumber = ["6282281917822@c.us"] // replace with your whatsapp number
        ...
        case '!sgif':
            if (isMedia) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    const mediaData = await decryptMedia(message, uaOverride)
                    client.reply(from, '[WAIT] Sedang di proses bentar ya ajg tunggu ± 1 min!', id)
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://trakteer.id/anwadev', donate)
            break
        case '!tts':
        ...
        case '!fb':
            ...
            break
        case '!creator':
            client.sendContact(from, '6282281917822@c.us')
            break
        case '!ig':
        ...
        case '!welcome':
            ...
            if (args[1].toLowerCase() === 'enable') {
                ...
                client.reply(from, 'Pilih enable atau disable Goblog!', id)
            }
            break
        case '!nsfwmenu':
            if (!isNsfw) return
        ...
        case '!readme':
            ...
            break
        case '!info':
            client.sendLinkWithAutoPreview(from, 'https://github.com/AnwaDeveloper/whatsapp-bot', info)
            break
        case '!snk':
